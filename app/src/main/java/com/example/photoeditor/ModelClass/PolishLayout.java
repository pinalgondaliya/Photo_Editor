...
public interface PolishLayout {
    ...
    public static class Info implements Parcelable {
        public static final Creator<Info> CREATOR = new Creator<Info>() { // from class: com.example.photoareditor.ModelClass.PolishLayout.Info.1
    ...
    public static class Step implements Parcelable {
        ...
        public static final Creator<Step> CREATOR = new Creator<Step>() { // from class: com.example.photoareditor.ModelClass.PolishLayout.Step.1
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // android.os.Parcelable.Creator
            /* renamed from: createFromParcel */
    ...
    public static class LineInfo implements Parcelable {
        public static final Creator<LineInfo> CREATOR = new Creator<LineInfo>() { // from class: com.example.photoareditor.ModelClass.PolishLayout.LineInfo.1
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // android.os.Parcelable.Creator
            /* renamed from: createFromParcel */
        ...
        public LineInfo(PolishLine polishLine) {
            this.startX = polishLine.startPoint().x;
            this.startY = polishLine.startPoint().y;
            this.endX = polishLine.endPoint().x;
            this.endY = polishLine.endPoint().y;
        }
