...
public class CollageBackgroundAdapter extends RecyclerView.Adapter<CollageBackgroundAdapter.ViewHolder> {
    ...
    public CollageBackgroundAdapter(Context context2, BackgroundGridListener backgroundGridListener, boolean z) {
        ArrayList arrayList = new ArrayList();
        this.squareViewList = arrayList;
        this.context = context2;
        this.backgroundListener = backgroundGridListener;
    ...
    public CollageBackgroundAdapter(Context context2, BackgroundGridListener backgroundGridListener, List<Drawable> list) {
        this.squareViewList = new ArrayList();
        this.context = context2;
        this.backgroundListener = backgroundGridListener;
        for (Drawable drawable : list) {
            this.squareViewList.add(new SquareView(1, "", false, true, drawable));
        }
    }
