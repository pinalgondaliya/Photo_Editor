...
public class StraightUtils {
    ...
    public static StraightLine createLine(StraightArea straightArea, PolishLine.Direction direction, float f) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static Pair<List<StraightLine>, List<StraightArea>> cutArea(StraightArea straightArea, int i, int i2) {
        int i3;
        ArrayList arrayList = new ArrayList();
        ArrayList arrayList2 = new ArrayList(i);
        StraightArea straightArea2 = new StraightArea(straightArea);
        for (int i4 = i + 1; i4 > 1; i4--) {
            StraightLine createLine = createLine(straightArea2, PolishLine.Direction.HORIZONTAL, (i4 - 1) / i4);
        ...
        while (true) {
            ...
            StraightLine createLine2 = createLine(straightArea3, PolishLine.Direction.VERTICAL, (i5 - 1) / i5);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static Pair<List<StraightLine>, List<StraightArea>> cutAreaSpiral(StraightArea straightArea) {
        ArrayList arrayList = new ArrayList();
