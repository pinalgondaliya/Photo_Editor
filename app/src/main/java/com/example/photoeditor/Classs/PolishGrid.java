...
public class PolishGrid {
    ...
    public PolishGrid(Drawable drawable2, PolishArea polishArea, Matrix matrix2) {
        this.drawable = drawable2;
        this.area = polishArea;
        this.matrix = matrix2;
        ...
        this.centerPoint = new PointF(polishArea.centerX(), polishArea.centerY());
    ...
    public boolean contains(PolishLine polishLine) {
        return this.area.contains(polishLine);
    }
    ...
    private void animateTranslate(final View view, final float f, final float f2) {
        ...
        this.animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            /* class com.example.photoareditor.Classs.PolishGrid.AnonymousClass1 */
    ...
    public void fillArea(final View view, boolean z) {
        ...
        if (!isFilledArea()) {
            ...
            this.animator.removeAllUpdateListeners();
            this.animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                /* class com.example.photoareditor.Classs.PolishGrid.AnonymousClass2 */
    ...
    public void updateWith(MotionEvent motionEvent, PolishLine polishLine) {
        ...
        if (polishLine.direction() == PolishLine.Direction.HORIZONTAL) {
            translate(0.0f, y);
        } else if (polishLine.direction() == PolishLine.Direction.VERTICAL) {
            translate(x, 0.0f);
        }
        RectF currentDrawableBounds = getCurrentDrawableBounds();
    ...
    public void setArea(PolishArea polishArea) {
        this.area = polishArea;
    }
