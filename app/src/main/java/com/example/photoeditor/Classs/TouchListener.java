...
public class TouchListener implements View.OnTouchListener {
    ...
    private class ScaleGestureListener extends ScaleGestureDetector.SimpleOnScaleGestureListener {
        ...
        private com.example.photoeditor.OutSideClass.Vector2D mPrevSpanVector;

        private ScaleGestureListener() {
            this.mPrevSpanVector = new Vector2D();
        }

        @Override // com.example.photoareditor.DripClass.ScaleGestureDetector.SimpleOnScaleGestureListener, com.example.photoareditor.DripClass.ScaleGestureDetector.OnScaleGestureListener
        ...
        public boolean onScale(View view, ScaleGestureDetector scaleGestureDetector) {
            ...
            float f = 0.0f;
            float f2 = 0.0f;
            transformInfo.deltaAngle = TouchListener.this.isRotateEnabled ? com.example.photoeditor.OutSideClass.Vector2D.getAngle(this.mPrevSpanVector, scaleGestureDetector.getCurrentSpanVector()) : 0.0f;
