...
public class Mirror3D_2Layer extends RelativeLayout implements ScaleGestureDetector.OnScaleGestureListener {
    ...
    public void init(Context context, final Mirror3D_2Layer mirror3D_2Layer) {
        ...
        setOnTouchListener(new OnTouchListener() { // from class: com.example.photoareditor.Classs.Mirror3D_2Layer.1
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                if ((Mirror3D_2Layer.this.mode == Mode.DRAG && Mirror3D_2Layer.this.scale >= Mirror3D_2Layer.MIN_ZOOM) || Mirror3D_2Layer.this.mode == Mode.ZOOM) {
                    ...
                    Mirror3D_2Layer mirror3D_2Layer22 = Mirror3D_2Layer.this;
                    mirror3D_2Layer22.dx = Math.min(Math.max(mirror3D_2Layer22.dx, -width), width);
                    Mirror3D_2Layer mirror3D_2Layer3 = Mirror3D_2Layer.this;
                    mirror3D_2Layer3.dy = Math.min(Math.max(mirror3D_2Layer3.dy, -height), height);
    ...
    public void init(Context context, final Mirror3D_2Layer mirror3D_2Layer, boolean z) {
        final ScaleGestureDetector scaleGestureDetector = new ScaleGestureDetector(context, this);
        setOnTouchListener(new OnTouchListener() { // from class: com.example.photoareditor.Classs.Mirror3D_2Layer.2
            @Override // android.view.View.OnTouchListener
            public boolean onTouch(View view, MotionEvent motionEvent) {
                int action = motionEvent.getAction() & 255;
                if (action == 0) {
    ...
    public void init(Context context, final Mirror3D_2Layer mirror3D_2Layer, Mirror3D_2Layer mirror3D_2Layer2, Mirror3D_2Layer mirror3D_2Layer3) {
        final ScaleGestureDetector scaleGestureDetector = new ScaleGestureDetector(context, this);
        setOnTouchListener(new OnTouchListener() { // from class: com.example.photoareditor.Classs.Mirror3D_2Layer.3
            @Override // android.view.View.OnTouchListener
            public boolean onTouch(View view, MotionEvent motionEvent) {
                int action = motionEvent.getAction() & 255;
                if (action == 0) {
                ...
                if ((Mirror3D_2Layer.this.mode == Mode.DRAG && Mirror3D_2Layer.this.scale >= Mirror3D_2Layer.MIN_ZOOM) || Mirror3D_2Layer.this.mode == Mode.ZOOM) {
                    ...
                    Mirror3D_2Layer mirror3D_2Layer22 = Mirror3D_2Layer.this;
                    mirror3D_2Layer22.dx = Math.min(Math.max(mirror3D_2Layer22.dx, -width), width);
                    Mirror3D_2Layer mirror3D_2Layer32 = Mirror3D_2Layer.this;
                    mirror3D_2Layer32.dy = Math.min(Math.max(mirror3D_2Layer32.dy, -height), height);
                    Log.i(Mirror3D_2Layer.TAG, "Width: " + Mirror3D_2Layer.this.child().getWidth() + ", scale " + Mirror3D_2Layer.this.scale + ", dx " + Mirror3D_2Layer.this.dx + ", max " + width);
                    Mirror3D_2Layer.this.applyScaleAndTranslation();
                    mirror3D_2Layer.applyScaleAndTranslation(-Mirror3D_2Layer.this.scale, Mirror3D_2Layer.this.scale, -Mirror3D_2Layer.this.dx, -Mirror3D_2Layer.this.dy);
                    mirror3D_2Layer.applyScaleAndTranslation(-Mirror3D_2Layer.this.scale, Mirror3D_2Layer.this.scale, -Mirror3D_2Layer.this.dx, Mirror3D_2Layer.this.dy);
                    mirror3D_2Layer22.applyScaleAndTranslation(Mirror3D_2Layer.this.scale, Mirror3D_2Layer.this.scale, Mirror3D_2Layer.this.dx, Mirror3D_2Layer.this.dy);
                    mirror3D_2Layer32.applyScaleAndTranslation(-Mirror3D_2Layer.this.scale, Mirror3D_2Layer.this.scale, -Mirror3D_2Layer.this.dx, Mirror3D_2Layer.this.dy);
                }
                return true;
            }
        });
    ...
    public void init(Context context, final Mirror3D_2Layer mirror3D_2Layer, Mirror3D_2Layer mirror3D_2Layer2) {
        final ScaleGestureDetector scaleGestureDetector = new ScaleGestureDetector(context, this);
        setOnTouchListener(new OnTouchListener() { // from class: com.example.photoareditor.Classs.Mirror3D_2Layer.4
            @Override // android.view.View.OnTouchListener
            public boolean onTouch(View view, MotionEvent motionEvent) {
                int action = motionEvent.getAction() & 255;
                if (action == 0) {
    ...
    public void init(Context context) {
        final ScaleGestureDetector scaleGestureDetector = new ScaleGestureDetector(context, this);
        setOnTouchListener(new OnTouchListener() { // from class: com.example.photoareditor.Classs.Mirror3D_2Layer.5
            @Override // android.view.View.OnTouchListener
            public boolean onTouch(View view, MotionEvent motionEvent) {
                int action = motionEvent.getAction() & 255;
                if (action == 0) {
