...
import com.example.photoeditor.Activity.StickerEraseActivity;
...
public class EraseView extends AppCompatImageView implements View.OnTouchListener {
    ...
    public class ScaleGestureListener extends ScaleGestureDetector.SimpleOnScaleGestureListener {
        ...
        private ScaleGestureListener() {
            this.mPrevSpanVector = new com.example.photoeditor.OutSideClass.Vector2D();
        }

        @Override // com.example.photoareditor.EraseClass.ScaleGestureDetector.SimpleOnScaleGestureListener, com.example.photoareditor.EraseClass.ScaleGestureDetector.OnScaleGestureListener
