...
public class Mirror3D_4Layer extends RelativeLayout implements ScaleGestureDetector.OnScaleGestureListener {
    ...
    public void init(Context context, final Mirror3D_4Layer mirror3D_4Layer) {
        ...
        setOnTouchListener(new OnTouchListener() { // from class: com.example.photoareditor.Classs.Mirror3D_4Layer.1
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                if ((Mirror3D_4Layer.this.mode == Mode.DRAG && Mirror3D_4Layer.this.scale >= Mirror3D_4Layer.MIN_ZOOM) || Mirror3D_4Layer.this.mode == Mode.ZOOM) {
                    ...
                    Mirror3D_4Layer mirror3D_4Layer22 = Mirror3D_4Layer.this;
                    mirror3D_4Layer22.dx = Math.min(Math.max(mirror3D_4Layer22.dx, -width), width);
                    Mirror3D_4Layer mirror3D_4Layer3 = Mirror3D_4Layer.this;
                    mirror3D_4Layer3.dy = Math.min(Math.max(mirror3D_4Layer3.dy, -height), height);
    ...
    public void init(Context context, final Mirror3D_4Layer mirror3D_4Layer, boolean z) {
        final ScaleGestureDetector scaleGestureDetector = new ScaleGestureDetector(context, this);
        setOnTouchListener(new OnTouchListener() { // from class: com.example.photoareditor.Classs.Mirror3D_4Layer.2
            @Override // android.view.View.OnTouchListener
            public boolean onTouch(View view, MotionEvent motionEvent) {
                int action = motionEvent.getAction() & 255;
                if (action == 0) {
    ...
    public void init(Context context, final Mirror3D_4Layer mirror3D_4Layer, Mirror3D_4Layer mirror3D_4Layer2, Mirror3D_4Layer mirror3D_4Layer3) {
        final ScaleGestureDetector scaleGestureDetector = new ScaleGestureDetector(context, this);
        setOnTouchListener(new OnTouchListener() { // from class: com.example.photoareditor.Classs.Mirror3D_4Layer.3
            @Override // android.view.View.OnTouchListener
            public boolean onTouch(View view, MotionEvent motionEvent) {
                int action = motionEvent.getAction() & 255;
                if (action == 0) {
                ...
                if ((Mirror3D_4Layer.this.mode == Mode.DRAG && Mirror3D_4Layer.this.scale >= Mirror3D_4Layer.MIN_ZOOM) || Mirror3D_4Layer.this.mode == Mode.ZOOM) {
                    ...
                    Mirror3D_4Layer mirror3D_4Layer22 = Mirror3D_4Layer.this;
                    mirror3D_4Layer22.dx = Math.min(Math.max(mirror3D_4Layer22.dx, -width), width);
                    Mirror3D_4Layer mirror3D_4Layer32 = Mirror3D_4Layer.this;
                    mirror3D_4Layer32.dy = Math.min(Math.max(mirror3D_4Layer32.dy, -height), height);
                    Log.i(Mirror3D_4Layer.TAG, "Width: " + Mirror3D_4Layer.this.child().getWidth() + ", scale " + Mirror3D_4Layer.this.scale + ", dx " + Mirror3D_4Layer.this.dx + ", max " + width);
                    Mirror3D_4Layer.this.applyScaleAndTranslation();
                    mirror3D_4Layer.applyScaleAndTranslation(-Mirror3D_4Layer.this.scale, Mirror3D_4Layer.this.scale, -Mirror3D_4Layer.this.dx, Mirror3D_4Layer.this.dy);
                    mirror3D_4Layer22.applyScaleAndTranslation(Mirror3D_4Layer.this.scale, Mirror3D_4Layer.this.scale, Mirror3D_4Layer.this.dx, Mirror3D_4Layer.this.dy);
                    mirror3D_4Layer32.applyScaleAndTranslation(-Mirror3D_4Layer.this.scale, Mirror3D_4Layer.this.scale, -Mirror3D_4Layer.this.dx, Mirror3D_4Layer.this.dy);
                }
                return true;
            }
        });
    ...
    public void init(Context context, final Mirror3D_4Layer mirror3D_4Layer, Mirror3D_4Layer mirror3D_4Layer2) {
        final ScaleGestureDetector scaleGestureDetector = new ScaleGestureDetector(context, this);
        setOnTouchListener(new OnTouchListener() { // from class: com.example.photoareditor.Classs.Mirror3D_4Layer.4
            @Override // android.view.View.OnTouchListener
            public boolean onTouch(View view, MotionEvent motionEvent) {
                int action = motionEvent.getAction() & 255;
                if (action == 0) {
    ...
    public void init(Context context) {
        final ScaleGestureDetector scaleGestureDetector = new ScaleGestureDetector(context, this);
        setOnTouchListener(new OnTouchListener() { // from class: com.example.photoareditor.Classs.Mirror3D_4Layer.5
            @Override // android.view.View.OnTouchListener
            public boolean onTouch(View view, MotionEvent motionEvent) {
                int action = motionEvent.getAction() & 255;
                if (action == 0) {
