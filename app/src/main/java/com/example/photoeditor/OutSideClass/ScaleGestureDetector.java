package com.example.photoeditor.OutSideClass;
...
public class ScaleGestureDetector {
    ...
    public static class SimpleOnScaleGestureListener implements OnScaleGestureListener {
        @Override // com.example.photoareditor.OutSideClass.ScaleGestureDetector.OnScaleGestureListener
            ...
            if (actionMasked == 1) {
                ...
                if (pointerCount > 2) {
                    ...
                    if (pointerId == i) {
                        ...
                        if (pointerId == this.mActiveId1 && (findNewActiveIndex = findNewActiveIndex(motionEvent, i, actionIndex)) >= 0) {
                            this.mListener.onScaleEnd(view, this);
